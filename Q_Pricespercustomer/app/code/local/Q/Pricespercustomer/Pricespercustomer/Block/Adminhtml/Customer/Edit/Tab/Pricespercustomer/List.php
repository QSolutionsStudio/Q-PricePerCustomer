 ...
 */
class Q_Pricespercustomer_Block_Adminhtml_Customer_Edit_Tab_Pricespercustomer_List
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('q_pricespercustomer/entity')
            ->getCollection()
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('price_adjustment', array(
            'header' => Mage::helper('q_pricespercustomer')->__('Price'),
        ...
        $this->addColumn('action', array(
            'header' => Mage::helper('q_pricespercustomer')->__('Action'),
            'width' => '50px',
            'type' => 'action',
            'getter' => 'getId',
            'actions' => array(
                array(
                    'caption' => Mage::helper('q_pricespercustomer')->__('Edit'),
                    'url' => array(
    ...
    public function getMainButtonsHtml()
    {
        ...
        ->setData(array(
            'label' => Mage::helper('q_pricespercustomer')->__('Create New Price'),
