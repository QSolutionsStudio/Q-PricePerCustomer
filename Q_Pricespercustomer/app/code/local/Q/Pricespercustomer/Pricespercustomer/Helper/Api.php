 ...
 */
class Q_Pricespercustomer_Helper_Api
    extends Mage_Core_Helper_Abstract
{
    ...
    public function retrieve($data, $storeId)
    {
        ...
        $pricePerCustomer = Mage::getModel('q_pricespercustomer/entity')->load($customerId, 'customer_id');
    ...
    {
        return Mage::getModel('q_pricespercustomer/entity')->getCollection()->getData();
    }

    /**
     * @param $productId
     * @param $customerId
     * @return Q_Pricespercustomer_Model_Entity
     * @throws Exception
     */
