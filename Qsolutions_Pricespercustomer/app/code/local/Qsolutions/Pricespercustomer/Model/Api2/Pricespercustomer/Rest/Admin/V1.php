 ...
 */
class Qsolutions_Pricespercustomer_Model_Api2_Pricespercustomer_Rest_Admin_V1 extends Mage_Api2_Model_Resource
{
    /**
     * @return $this
     * @throws Exception
    ...
    public function _retrieve()
    {
        ...
        try {
            return Mage::helper('qsolutions_pricespercustomer/api')->retrieve($data, $storeId);
    ...
    {
        return Mage::helper('qsolutions_pricespercustomer/api')->retrieveCollection();
    }
